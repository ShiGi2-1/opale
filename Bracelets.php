...
<body>
            ...
            <div class="ongles ">
                ...
                <div class="menu-deroulant-or"><a href="or.php"> Catalogues  </a>
                    <ul class="sous-menu">
                        ...
                        <li class="sous-menu-illuminating"> <a href="Bracelets.php"> Bracelets</a></li>
                    </ul>
                </div>
    ...
    <main>
        ...
        <div class="titre">
            <h1>Bracelets</h1>
            <P>“Les diamants peuvent être les meilleurs amis des filles, mais les perles vous feront briller comme le clair de lune” </P>
        </div>
        ...
        <section>
            ...
            <?php
                ...
                $req = mysqli_query($con, "SELECT * FROM produit where categorie='bracelet'");
            ...
            <div class="article">
                ...
                <script>
                    ...
                    // Redirection vers panier.php
                    window.location.href = "Bracelets.php";
                    }
                </script>
            </div>
            <?php } ?>
