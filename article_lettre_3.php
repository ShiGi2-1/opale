    ...
    <main>
        ...
        <section class="container">
            <div class="row-left">
                <div class="row-1">
                    <div class="">
                        <img src="./IMG/Lettre d'amour/bracelet44.jpg" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/Lettre d'amour/bracelet11.jpg" alt="">
                    </div>
                </div>

                <div class="row-2">
                    <div class="">
                        <img src="./IMG/Lettre d'amour/bracelet33.jpg" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/Lettre d'amour/bracelet22.jpg" alt="">
                    </div>
                </div>
