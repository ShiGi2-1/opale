    ...
    <main>
        ...
        <section class="container">
            <div class="row-left">
                <div class="row-1">
                    <div class="">
                        <img src="./IMG/Lettre d'amour/collier22 (1).webp" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/Lettre d'amour/a9e94e6d0f644ec8866082ecd4ace6cd3d59a2e8_original.jpg" alt="">
                    </div>
                </div>

                <div class="row-2">
                    <div class="">
                        <img src="./IMG/Lettre d'amour/collier11webp (1).webp" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/Lettre d'amour/ea915aa5a2c6c7a4941dff1f0fdc6bf1ac62c1d8_original.jpg" alt="">
                    </div>
                </div>

                <div class="row-3">
                    <div class="">
                        <img src="./IMG/Lettre d'amour/55.webp" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/Lettre d'amour/pierre-amethyste (1).jpg" alt="">
                    ...
                    <div>
                        ...
                        <div>
                            <div class="buttom-nombre">
                                ...
                                <div class="button">
                                    <a href="ajouter_panier.php?id=13" class="id_product">
                    ...
                    <div class="onglets">
                        ...
                        <div id="discription" class="tabcontent">
                            ...
                            <p style="text-align: center; margin-top: 30px; ">
                                Ce collier exquis est orné d'un pendentif en forme de câlin,
                                ciselé avec précision dans de l'or brillant. En son centre,
                                une pierre rose délicate révèle toute la tendresse d'un câlin intime,
                                évoquant la chaleur et la connexion profonde des amoureux. Portez ce
                                collier pour ressentir la douce étreinte de l'amour à chaque instant.
                            </p>             
