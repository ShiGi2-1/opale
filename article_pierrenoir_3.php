    ...
    <main>
        ...
        <section class="container">
            <div class="row-left">
                <div class="row-1">
                    <div class="">
                        <img src="./IMG/La pierre noir/p4b.png" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/La pierre noir/p4f.png" alt="">
                    </div>
                </div>

                <div class="row-2">
                    <div class="">
                        <img src="./IMG/La pierre noir/bracelet-mykonos-onyx-plaque-or-skalli.png" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/La pierre noir/p7a.png" alt="">
                    </div>
                </div>
                ...
                <div class="row-3">
                    ...
                    <div class="">
                        <img src="./IMG/La pierre noir//79272b42-c6a8-4ec8-9cec-4087fabde736.jpeg (1).png" alt="">
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div>
                            <div class="buttom-nombre">
                                ...
                                <div class="button">
                                    <a href="ajouter_panier.php?id=7" class="id_product">
                    ...
                    <div class="onglets">
                        ...
                        <div id="discription" class="tabcontent">
                            ...
                            <p style="text-align: center; margin-top: 30px; ">
                                Un bracelet fin en or avec une pierre noire rectangulaire comme
                                élément central. Son design délicat en fait un accessoire polyvalent
                                qui peut être porté seul ou empilé avec d'autres bracelets pour
                                un style personnalisé et tendance.
                            </p>             
                        ...
                        <div id="details" class="tabcontent">
                            ...
                            <p style="text-align: center; margin-top: 30px; ">
                                Matériau : Plaqué or 18 carats avec pierres de verre noires.
                            </p>
                        </div>
