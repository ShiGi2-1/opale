    ...
    <main>
        ...
        <section class="container">
            <div class="row-left">
                <div class="row-1">
                    <div class="">
                        <img src="./IMG/green/bracelet2_green (1).jpg" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/green/bracelet_green (1).jpg" alt="">
                    </div>
                </div>

                <div class="row-2">
                    <div class="">
                        <img src="./IMG/green/bracelet3_green (1).jpg" alt="">
                    </div>
                    <div class="">
                ...
                <div class="row-3">
                    <div class="">
                        <img src="./IMG/green/Collier-MAYAN-onyx-vert-et-bracelet-seema-onyx-vert-femme-Vok (1).jpg" alt="">
                    </div>
                    <div class="">
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div>
                            <div class="buttom-nombre">
                                ...
                                <div class="button">
                                    <a href="ajouter_panier.php?id=11" class="id_product">
