    ...
    <main>
        ...
        <section class="container">
            <div class="row-left">
                <div class="row-1">
                    <div class="">
                        <img src="./IMG/La pierre noir/p1f.png" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/La pierre noir/p1b.png" alt="">
                    </div>
                </div>

                <div class="row-2">
                    <div class="">
                        <img src="./IMG/La pierre noir/68fdc95f5fe31f84a6c6d1f636f0a9a7.jpg" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/La pierre noir/ab5b9146bb1533771aab134581b7df21.jpg" alt="">
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div>
                            <div class="buttom-nombre">
                                ...
                                <div class="button">
                                    <a href="ajouter_panier.php?id=6" class="id_product">
                    ...
                    <div class="onglets">
                        ...
                        <div id="discription" class="tabcontent">
                            ...
                            <p style="text-align: center; margin-top: 30px; ">
                                Une bague unique en or rose avec un motif audacieux composé de petites pierres noires. 
                                Son design artistique et moderne en fait un accessoire accrocheur qui peut être porté
                                seul ou associé à d'autres bagues pour un look plus dramatique.
                            </p>             
                        ...
                        <div id="details" class="tabcontent">
                            ...
                            <p style="text-align: center; margin-top: 30px; ">
                                Matériau : Plaqué or rose 18 carats avec pierres de verre noires.
                            </p>
                        </div>
