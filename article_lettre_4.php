        ...
        <section class="container">
            <div class="row-left">
                <div class="row-1">
                    ...
                    <div class="">
                        <img src="./IMG/Lettre d'amour/boucle22 (1).png" alt="">
                    </div>
                </div>

                <div class="row-2">
                    <div class="">
                        <img src="./IMG/Lettre d'amour/boucle11.jpg" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/Lettre d'amour/075000880648_alt1 (1).png" alt="">
                    </div>
                </div>
                ...
                <div class="row-3">
                    ...
                    <div class="">
                        <img src="./IMG/Lettre d'amour/" alt="">
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div>
                            <div class="buttom-nombre">
                                ...
                                <div class="button">
                                    <a href="ajouter_panier.php?id=16" class="id_product">
                    ...
                    <div class="onglets">
                        ...
                        <div id="discription" class="tabcontent">
                            ...
                            <p style="text-align: center; margin-top: 30px; ">
                                Ces boucles d'oreilles éblouissantes captivent le regard avec leur design
                                sophistiqué en or doré. Chaque boucle est ornée d'une pierre rose lumineuse,
                                rappelant la douceur d'un baiser passionné échangé entre amants. Portez ces
                                boucles d'oreilles pour ajouter une touche de romance dorée à chaque mouvement.
                            </p>             
