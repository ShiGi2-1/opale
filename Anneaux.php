...
<body>
            ...
            <div class="ongles ">
                ...
                <div class="menu-deroulant-or"><a href="./or.html"> Catalogues </a>
                    <ul class="sous-menu">
                        ...
                        <li class="sous-menu-illuminating"> <a href="Anneaux.php">Anneaux</a></li>
    ...
    <main>
        ...
        <div class="titre">
            <h1>Anneaux</h1>
            <P>"La mode n’est ni morale ni amorale mais elle est faite pour remonter le moral."</P>
        </div>
        ...
        <section>
            ...
            <?php
                ...
                $req = mysqli_query($con, "SELECT * FROM produit where categorie='bague'");
            ...
            <div class="article">
                ...
                <script>
                    ...
                    window.location.href = "Anneaux.php";
                    }
                </script>
            </div>
            <?php } ?>
