    ...
    <main>
        ...
        <section class="container">
            <div class="row-left">
                <div class="row-1">
                    <div class="">
                        <img src="./IMG/La pierre noir/p3b.png" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/La pierre noir//21.png" alt="">
                    </div>
                </div>

                <div class="row-2">
                    <div class="">
                        <img src="./IMG/La pierre noir/22.png" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/La pierre noir/23.png" alt="">
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div>
                            <div class="buttom-nombre">
                                ...
                                <div class="button">
                                    <a href="ajouter_panier.php?id=8" class="id_product">
                    ...
                    <div class="onglets">
                        ...
                        <div id="discription" class="tabcontent">
                            ...
                            <p style="text-align: center; margin-top: 30px; ">
                                Des boucles d'oreilles créoles en or avec une série de petites pierres
                                noires disposées le long de la circonférence. Elles ajoutent une touche
                                de glamour subtil à n'importe quelle tenue, que ce soit pour une soirée
                                spéciale ou pour un look de tous les jours.
                            </p>             
                        ...
                        <div id="details" class="tabcontent">
                            ...
                            <p style="text-align: center; margin-top: 30px; ">
                                Matériau : Plaqué or 18 carats avec pierre de verre noire.
                            </p>
                        </div>
