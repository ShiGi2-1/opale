        ...
        <section class="container">
            <div class="row-left">
                <div class="row-1">
                    ...
                    <div class="">
                        <img src="./IMG/Cameleon/d0f.png" alt="">
                    </div>
                </div>

                <div class="row-2">
                    <div class="">
                        <img src="./IMG/Cameleon/d0b.png" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/Cameleon/IMG_6140_2.webp" alt="">
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div>
                            <div class="buttom-nombre">
                                ...
                                <div class="button">
                                    <a href="ajouter_panier.php?id=2" class="id_product">
                    ...
                    <div class="onglets">
                        ...
                        <div id="discription" class="tabcontent">
                            ...
                            <p style="text-align: center; margin-top: 30px; ">
                                Une bague en or avec un cabochon rond en nacre au centre.
                                La nacre donne un effet irisé subtil à la bague, lui donnant
                                un aspect élégant et intemporel. Parfait pour une touche de
                                sophistication dans n'importe quelle tenue.
                            </p>             
