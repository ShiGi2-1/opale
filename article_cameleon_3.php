    ...
    <main>
        ...
        <section class="container">
            <div class="row-left">
                <div class="row-1">
                    <div class="">
                        <img src="./IMG/Cameleon/d11.webp" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/Cameleon/bracelet (2).webp" alt="">
                    </div>
                </div>

                <div class="row-2">
                    <div class="">
                        <img src="./IMG/Cameleon/d9.webp" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/Cameleon/bracelet (1).webp" alt="">
                    </div>
                </div>
                        ...
                        <div>
                            <div class="buttom-nombre">
                                <div><label for="nombre"></label>
                                    ...
                                    <div class="button">
                                        <a href="ajouter_panier.php?id=3" class="id_product">
                    ...
                    <div class="onglets">
                        ...
                        <div id="discription" class="tabcontent">
                            ...
                            <p style="text-align: center; margin-top: 30px; ">
                                Un bracelet délicat en or avec un pendentif en nacre
                                en forme de goutte. Les maillons de la chaîne ajoutent
                                une touche de féminité et de légèreté à ce bracelet qui
                                peut être porté seul ou associé à d'autres bracelets
