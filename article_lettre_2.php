    ...
    <main>
        ...
        <section class="container">
            <div class="row-left">
                <div class="row-1">
                    <div class="">
                        <img src="./IMG/Lettre d'amour/bague_b.jpg" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/Lettre d'amour/bague_f - Copie.jpg" alt="">
                    </div>
                </div>

                <div class="row-2">
                    <div class="">
                        <img src="./IMG/Lettre d'amour/gingko_03 (1).png" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/Lettre d'amour/gingko_02 (1).png" alt="">
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div>
                            <div class="buttom-nombre">
                                ...
                                <div class="button">
                                    <a href="ajouter_panier.php?id=14" class="id_product">
                    ...
                    <div class="onglets">
                        ...
                        <div id="discription" class="tabcontent">
                            ...
                            <p style="text-align: center; margin-top: 30px; ">
                                Cette bague élégante est forgée dans l'or le plus fin, avec une silhouette
                                gracieuse qui évoque la forme d'un cœur. Au centre de ce cœur, une pierre
                                rose étincelante brille avec un éclat captivant, représentant le cœur vibrant
                                d'une romance profonde. Portez cette bague pour illuminer chaque geste d'un éclat d'amour.
                            </p>             
