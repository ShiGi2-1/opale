    ...
    <main>
        ...
        <section class="container">
            <div class="row-left">
                <div class="row-1">
                    <div class="">
                        <img src="./IMG/Cameleon/d16b.png" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/Cameleon/boucle (2).webp" alt="">
                    </div>
                </div>

                <div class="row-2">
                    <div class="">
                        <img src="./IMG/Cameleon/boucle (1).webp" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/Cameleon/boucle (3).webp" alt="">
                    </div>
                </div>

                <div class="row-3">
                    <div class="">
                        <img src="./IMG/Cameleon/d16f.png" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/Cameleon/pr.webp" alt="">
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div>
                            <div class="buttom-nombre">
                                ...
                                <div class="button">
                                    <a href="ajouter_panier.php?id=4" class="id_product">
                    ...
                    <div class="onglets">
                        ...
                        <div id="discription" class="tabcontent">
                            ...
                            <p style="text-align: center; margin-top: 30px; ">
                                Des boucles d'oreilles en or avec un design moderne et artistique.
                                Chaque boucle comporte une chaîne tombante en or, créant un effet
                                de mouvement subtil et élégant. Les boucles d'oreilles sont ornées de nacre,
                                ajoutant une touche de sophistication à n'importe quel look.
                            </p>             
