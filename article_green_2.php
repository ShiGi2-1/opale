    ...
    <main>
        ...
        <section class="container">
            <div class="row-left">
                <div class="row-1">
                    <div class="">
                        <img src="./IMG/green/bague-b.jpg" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/green/bague-f.jpg" alt="">
                    </div>
                </div>

                <div class="row-2">
                    <div class="">
                        <img src="./IMG/green/9.jpg" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/green/bemaad_bagues_izy_onyxvert_2.jpg" alt="">
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div>
                            <div class="buttom-nombre">
                                ...
                                <div class="button">
                                    <a href="ajouter_panier.php?id=10" class="id_product">
