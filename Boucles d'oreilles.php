...
<body>
            ...
            <div class="ongles ">
                ...
                <div class="menu-deroulant-or"><a href="./or.html"> Catalogues  </a>
                    <ul class="sous-menu">
                        ...
                        <li class="sous-menu-illuminating"> <a href="Boucles d'oreilles.php"> Boucles d'oreilles</a></li>
    ...
    <main>
        ...
        <div class="titre">
            ...
            <P>"Un bijoux a le pouvoir d'être cette petite chose qui peut vous fait vous sentir unique"</P>
        </div>
        ...
        <section>
            ...
            <?php
                ...
                $req = mysqli_query($con, "SELECT * FROM produit where categorie='boucle'");
            ...
            <div class="article">
                ...
                <script>
                    ...
                    window.location.href = "Boucles d'oreilles.php";
                    }
                </script>
            </div>
            <?php } ?>
