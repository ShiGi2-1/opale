    ...
    <main>
        ...
        <section class="container">
            <div class="row-left">
                <div class="row-1">
                    <div class="">
                        <img src="./IMG/Cameleon/collier (1).jpg" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/Cameleon/collier (1).webp" alt="">
                    </div>
                </div>

                <div class="row-2">
                    <div class="">
                        <img src="./IMG/Cameleon/collier (2).jpg" alt="">
                    </div>
                    <div class="">
                        <img src="./IMG/Cameleon/collier (2).webp" alt="">
                    </div>
                </div>

                <div class="row-3">
                    <div class="">
                        <img src="./IMG/Cameleon/collier (3).webp" alt="">
                    </div>
                    <div class="">
                    ...
                    <div>
                        ...
                        <div>
                            <div class="buttom-nombre">
                                ...
                                <div class="button">
                                    <a href="ajouter_panier.php?id=1" class="id_product">
                    ...
                    <div class="onglets">
                        ...
                        <div id="discription" class="tabcontent">
                            ...
                            <p style="text-align: center; margin-top: 30px; ">
                                Un collier en or avec un pendentif en forme de cercle ajouré,
                                orné d'une nacre au centre. Le design minimaliste et élégant
                                en fait un accessoire polyvalent qui peut être porté au quotidien
